export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '用户每支付 1 USD 可获得多少 USD 余额',
        balanceRechargePreview: '预览：支付 1 USD = {usd} USD 余额',
        ...
        field_paymentCurrencyHint: '平台余额和金额展示默认按 USD。仅在上游账户明确要求时选择其他服务商币种；NOWPayments 的法币选项只用于充值页参考估算。',
        ...
        field_nowpaymentsApiBaseHint: 'NOWPayments API 基础地址。沙箱测试使用 https://api-sandbox.nowpayments.io/v1，生产环境使用 https://api.nowpayments.io/v1。',
        field_nowpaymentsPayCurrencyHint: '客户支付的加密货币及网络（如 usdttrc20 = TRON 网络的 USDT）。完整列表见 https://nowpayments.io/supported-coins。',
        nowpaymentsGuideSummary: '注册 NOWPayments 账户，在后台「Store Settings」中生成 API Key 和 IPN Secret Key。沙箱测试请使用沙箱地址对应的测试密钥。',
        nowpaymentsGuideNote: '请确保 IPN 回调地址配置正确，IPN Secret 与 NOWPayments 后台设置一致。推荐使用 TRC-20 (TRON 网络) 以降低手续费。',
        limitsTitle: '限额配置',
        limitSingleMin: '单笔最低',
        limitSingleMax: '单笔最高',
        limitDaily: '每日限额',
  ...
  payment: {
    ...
    enterAmount: '输入金额',
    paymentMethod: '支付方式',
    currencyLabel: '币种：{currency}',
    fiatCurrency: '法币',
    estimateCurrencyLabel: '参考法币：{currency}',
    networkLabel: '网络：{network}',
    network: '选择网络',
    fee: '手续费',
    actualPay: '实付金额',
    createOrder: '确认支付',
    ...
    qr: {
      ...
      walletAddressHint: '请向上述钱包地址转入下方显示的确切金额，系统将自动检测到账。',
      transferAmount: '转账金额',
    },
    orders: {
      title: '我的订单',
    ...
    currentBalance: '当前余额',
    balanceUnitHint: '账户余额统一按 USD 记账与展示。',
    groupFallback: '分组 #{id}',
    ...
    fiatCurrenciesAvailable: '可选 {count} 个法币',
    networksAvailable: '可选 {count} 个网络',
    estimatedFiatAmount: '参考法币金额',
    estimatedFiatHint: '{usd} 约等于 {amount}，仅供参考，非实时汇率。',
    estimatedFiatHintEmpty: '将按所选法币显示参考金额，仅供参考，非实时汇率。',
    paymentAmountWithCurrency: '充值金额（{currency}）',
    actualPayWithCurrency: '实付金额（{currency}）',
    creditedBalanceUsd: '预计到账余额（USD）',
    creditedBalanceHint: '到账余额统一按 USD 记账。链上实际需支付的加密货币数量以下单结果为准。',
    paymentCurrencyHint: '当前支付方式按 {currency} 计价，你输入的金额和实付金额都使用这个币种。',
    cryptoAmountAfterCreateHint: '链上实际需支付的加密货币数量会在创建订单后由网关返回，例如 X USDT。',
    rechargeRatePreview: '当前倍率：支付 1 USD = {usd} USD 余额',
    refundReason: '退款原因',
