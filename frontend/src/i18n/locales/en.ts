export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How many USD balance the user receives for each 1 USD paid',
        balanceRechargePreview: 'Preview: 1 USD paid = {usd} USD balance',
        ...
        field_paymentCurrencyHint: 'Default is USD for the platform balance and payment display. Only choose another provider currency when the upstream account requires it; NOWPayments fiat options are shown as reference estimates on the recharge page.',
        ...
        field_nowpaymentsApiBaseHint: 'NOWPayments API base URL. Use https://api-sandbox.nowpayments.io/v1 for sandbox testing, and https://api.nowpayments.io/v1 for production.',
        field_nowpaymentsPayCurrencyHint: 'The cryptocurrency that customers will pay with, including the network (e.g. usdttrc20 = USDT on TRON). Full list at https://nowpayments.io/supported-coins.',
        nowpaymentsGuideSummary: 'Create a NOWPayments account, generate an API key and IPN secret key from the Store Settings. For sandbox testing, use the sandbox API base URL with test keys.',
        nowpaymentsGuideNote: 'Make sure the IPN callback URL is configured correctly. The IPN Secret must match the one set in your NOWPayments store settings. Use TRC-20 (TRON) for lower fees.',
        limitsTitle: 'Limits',
  ...
  payment: {
    ...
    estimateCurrencyLabel: 'Reference Fiat: {currency}',
    ...
    qr: {
      ...
      walletAddressHint: 'Please transfer to the address below using your wallet app and wait for confirmation',
      transferAmount: 'Transfer Amount',
    },
    orders: {
      title: 'My Orders',
    ...
    currentBalance: 'Current Balance',
    balanceUnitHint: 'Account balance is recorded and displayed in USD.',
    ...
    fiatCurrenciesAvailable: '{count} fiat currencies available',
    networksAvailable: '{count} networks available',
    estimatedFiatAmount: 'Estimated Fiat Amount',
    estimatedFiatHint: '{usd} is approximately {amount}. Reference only, not a live exchange rate.',
    estimatedFiatHintEmpty: 'A reference fiat estimate will be shown for the selected currency. This is not a live exchange rate.',
    paymentAmountWithCurrency: 'Recharge Amount ({currency})',
    actualPayWithCurrency: 'Actual Payment ({currency})',
    creditedBalanceUsd: 'Estimated Credited Balance (USD)',
    creditedBalanceHint: 'Credited balance is recorded in USD. The exact on-chain crypto amount is confirmed by the order result.',
    paymentCurrencyHint: 'The current payment method is charged in {currency}. The amount you enter and the amount you pay use this currency.',
    cryptoAmountAfterCreateHint: 'The exact on-chain crypto amount is returned after the order is created, for example X USDT.',
    rechargeRatePreview: 'Current rate: 1 USD paid = {usd} USD balance',
