...
type CreatePaymentRequest struct {
	...
	PayCurrency        string // User-selected crypto network (NOWPayments), empty = use provider default
}
...
type CreatePaymentResponse struct {
	...
	WalletAddress  string                  // Crypto wallet address for manual transfer (e.g. NOWPayments)
	CryptoAmount   string                  // Crypto amount the user needs to send
	CryptoCurrency string                  // Crypto currency/network (e.g. "usdttrc20")
