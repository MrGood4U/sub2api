...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		RPMLimit:                        g.RPMLimit,
		SupportsOpenAIChatCompletions:   g.SupportsOpenAIChatCompletions,
		SupportsOpenAIResponses:         g.SupportsOpenAIResponses,
		SupportsAnthropicMessages:       g.SupportsAnthropicMessages,
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		GroupIDs:                      a.GroupIDs,
		SupportsOpenAIChatCompletions: a.SupportsOpenAIChatCompletions,
		SupportsOpenAIResponses:       a.SupportsOpenAIResponses,
		SupportsAnthropicMessages:     a.SupportsAnthropicMessages,
	}
